...
func load_level(lvl:int) -> void:
	const FALCON = preload("res://scripts/objects/falcon.tscn")
	const SPAWN = preload("res://scripts/objects/spawn_point.tscn")
...
func spawn_player(mpId:int, playerId:int):
	const PLAYER = preload("res://scripts/objects/player.tscn")
...
func spawn_enemy(slot:int):
	...
	const ENEMY = preload("res://scripts/objects/enemy.tscn")
